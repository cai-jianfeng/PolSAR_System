...
pre_path = '../data/prepro_flevoland4/predict_labels_DCNN_7.xlsx'
color_path = '../data/prepro_flevoland4/pre_data/color.xlsx'
label_path = '../data_patch/T_RI_7/predict.txt'
label_pic_name = 'flevoland_DCNN_10%_10_7x7_without_label0'
mode = 'predict'
colors = []
if color_path:
