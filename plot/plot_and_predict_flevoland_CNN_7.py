...
import os
CNN_model = CNN()
CNN_parameters = torch.load('../CNN/CNN_model_parameter_whole_dataset_10%_10_7x7.pkl')  # 加载训练好的模型参数
...
label_pic_name = 'flevoland4_CNN_10%_10_7x7'
