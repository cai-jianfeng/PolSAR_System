...
pre_path = '../data/prepro_flevoland4/predict_labels_CNN_1%_10_7x7.xlsx'
color_path = '../data/prepro_flevoland4/pre_data/color.xlsx'
label_path = '../data_patch/TR/predict.txt'
label_pic_name = 'flevoland_CNN_1%_10_without_label0_7'
mode = 'predict'
colors = []
if color_path:
