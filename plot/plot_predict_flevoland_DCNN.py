...
plot.plot_labels(label_path='../data/prepro_flevoland4/predict_labels.xlsx',
...
dim = data_info['dim']
target = result()
acc = target.accuracy_predict_txt(label_path='../data_patch/T_RI/predict.txt',
                      predict_path='../data/prepro_flevoland4/predict_labels.xlsx',
                      dim=dim)
print('acc:', acc)
