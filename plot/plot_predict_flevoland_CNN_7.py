...
plot.plot_labels(label_path='../data/prepro_flevoland4/predict_labels_CNN_7.xlsx',
                 color_path='../data/prepro_flevoland4/pre_data/color.xlsx',
                 label_pic_name='flevoland_CNN_10%_10_7x7')
readme_json = '../data_patch/T_R_7/readme.json'
with open(readme_json, 'r') as f:
    data_info = json.load(f)
dim = data_info['dim']
target = result()
acc = target.accuracy_predict_txt(label_path='../data_patch/T_R_7/predict.txt',
