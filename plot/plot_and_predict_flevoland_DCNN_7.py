...
from DCNN.DCNN_without_label0 import Double_CNN
from data_process.data_preprocess import Data
import os

DCNN_model = Double_CNN()
DCNN_parameters = torch.load('../DCNN/DCNN_model_parameter_whole_dataset_10%_10_7x7.pkl')  # 加载训练好的模型参数
...
if os.path.getsize(target_path) == 0:
    ...
    predict_list_path = '../data_patch/T_RI_7/predict.txt'
...
label_pic_name = 'flevoland4_DCNN_10%_10_7x7'
